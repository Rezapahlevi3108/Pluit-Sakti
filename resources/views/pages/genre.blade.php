...
<section class="margin-top-145 margin-bottom-118">
    <div class="container">
        <div class="d-block d-md-flex align-items-center justify-content-between">
            <h1 class="font-size-36 font-weight-700 text-white d-none d-md-block">Genre</h1>
            <h1 class="font-size-28 font-weight-700 text-white d-block d-md-none">Genre</h1>
        </div>
        <div class="row mt-5">
